...
namespace DevSkill.Blog.Application.Tests.Features.Post.Commands.BlogPostCommand;
...
public class CreateBlogPostCommandHandlerTests
{
    ...
    [Test]
    public async Task Create_BlogPost_When_Command_IsNotNull()
    {
        //Arrange
    ...
    [Test]
    public async Task Return_Null_When_Command_IsNull()
    {
        //Arrange
        CreateBlogPostCommand command = null;
