...
{
    /// <inheritdoc />
    public partial class AddGetCategoriesWithPostsSP : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = """
                CREATE OR ALTER PROCEDURE [dbo].[GetCategoriesWithPosts] 
                ...
                BEGIN
                	...
                	SELECT 
                	post.Id,post.Title,post.ThumbnailName,post.Url,post.PublishedAt
        ...
        {
            var sql = "DROP PROCEDURE [dbo].[GetCategoriesWithPosts]";
            migrationBuilder.Sql(sql);
        }
    }
}
